...
class CalendarManager:
    ...
    def findNextMeetingIncluding(self, name):
...
def test_find_next_meeting(scenario1_meetings_manager):
    # run some code
    meeting = scenario1_meetings_manager.findNextMeetingIncluding("Matt")
...
def test_find_next_meeting_reordered(scenario2_meetings_manager):
    meeting = scenario2_meetings_manager.findNextMeetingIncluding("Bob")
...
def test_mgr_findNextMeeting_calls_accessor():
    ...
    manager.findNextMeetingIncluding("Alice")
...
def test_mgr_findNextMeeting_result():
    ...
    manager = CalendarManager(accessor)
    meeting = manager.findNextMeetingIncluding  ("Alice")
...
def checkFindMeeting(manager):
    nextMeetingInfo = manager.findNextMeetingIncluding("Matt")
